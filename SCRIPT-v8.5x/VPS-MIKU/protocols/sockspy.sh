...
cd socks
patch="https://raw.githubusercontent.com/mikuservices/VPS-MIKU/master/LINKS-LIBRARIES/backsocz.zip"
arq="backsocz.zip"
...
PythonDic_fun () {
echo -e "\033[1;33m  Selecciona un puerto local\033[1;37m" 
msg -bar
echo -ne "\033[1;97mInserta un puerto SSH/DROPBEAR activo: \033[1;92m" && read puetoantla 
msg -bar
echo -ne "\033[1;97mRespuesta encabezada (200,101,404,500,etc): \033[1;92m" && read rescabeza
msg -bar
(
less << PYTHON  > /etc/VPS-MIKU/protocols/PDirect.py
...
chmod +x /etc/VPS-MIKU/protocols/PDirect.py

screen -dmS pydic-"$porta_socket" python ${SCPinst}/PDirect.py "$porta_socket" "$texto_soket" && echo ""$porta_socket" "$texto_soket"" >> /etc/VPS-MIKU/PortPD.log
}
...
remove_fun () {
echo -e "$(fun_trans  "Deteniendo socks")"
msg -bar
...
msg -bar
rm -rf /etc/VPS-MIKU/PortPD.log
echo "" > /etc/VPS-MIKU/PortPD.log
exit 0
}
iniciarsocks () {
...
msg -bar 
msg -tit
msg -ama "   INSTALADOR DE PROXY VPS-MIKU By MOD @mikuservices"
msg -bar
...
echo -e "\033[1;33m       Elige un puerto proxy primario"
msg -bar
porta_socket=
...
echo -e "$(fun_trans  "Introducce un minibanner en HTML")"
msg -bar
