...
eth=$(ifconfig | grep -v inet6 | grep -v lo | grep -v 127.0.0.1 | grep "encap:Ethernet" | awk '{print $1}')
    [[ $eth != "" ]] && {
    msg -bar
    echo -e "${cor[3]} $(fun_trans "Aplicar cambios para mejorar entregas de paquetes SSH?")"
...
fun_dropbear () {
 ...
 msg -bar
 echo -e "\033[1;32m $(fun_trans ${id} "ELIMINANDO DROPBEAR")"
 msg -bar
 service dropbear stop & >/dev/null 2>&1
 fun_bar "apt-get remove dropbear -y"
 msg -bar
 echo -e "\033[1;32m $(fun_trans "Dropbear Eliminado")"
 msg -bar
...
msg -bar
msg -tit
echo -e "\033[1;32m $(fun_trans "   Instalador de Dropbear | VPS-MIKU By @mikuservices")"
msg -bar
echo -e "\033[1;31m $(fun_trans "Digita los puertos en el siguiente orden:\n")\033[1;32m 22 80 81 82 85 90\033[1;37m"
msg -bar
...
TTOTAL=($DPORT)
    for((i=0; i<${#TTOTAL[@]}; i++)); do
        ...
        echo -e "\033[1;33m $(fun_trans  "Elige puerto:")\033[1;32m ${TTOTAL[$i]} OK"
        PORT="$PORT ${TTOTAL[$i]}"
        } || {
        echo -e "\033[1;33m $(fun_trans  "Elige puerto:")\033[1;31m ${TTOTAL[$i]} FAIL"
        }
   done
  [[  -z $PORT ]] && {
...
echo -e "${cor[3]} $(fun_trans "El protocolo Dropbear fue activado EXITOSAMENTE")"
msg -bar
#UFW
