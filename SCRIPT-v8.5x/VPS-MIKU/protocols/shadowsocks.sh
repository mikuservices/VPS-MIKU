...
return 0
	   ...
	   msg -bar
	   msg -tit
	   msg -ama "        INSTALADOR SHADOWSOCKS By @mikuservices"
	   msg -bar
...
#ESCOLHENDO LISTEN
msg -bar
      echo -e "\033[1;33m $(fun_trans ${id} "Elige un puerto listen")\033[0m"
	  msg -bar
      while true; do
      unset Lport
      read -p " Port: " Lport
...
#INICIANDO
msg -bar
echo -e "\033[1;33m $(fun_trans ${id} "Introduce la contrasena shadowsocks")\033[0m"
...
[[ $value != "" ]] && value="\033[1;32mINICIADO CORRECTAMENTE" || value="\033[1;31mERROR"
msg -bar
echo -e "${value}"
msg -bar
return 0
